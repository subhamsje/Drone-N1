...
import { BufferPoint as BufferPoint_2 } from 'cesium';
import { BufferPointCollection as BufferPointCollection_2 } from 'cesium';
import { BufferPointMaterial } from 'cesium';
import { BufferPolygon as BufferPolygon_2 } from 'cesium';
import { BufferPolygonCollection as BufferPolygonCollection_2 } from 'cesium';
import { BufferPolygonMaterial } from 'cesium';
import { BufferPolyline as BufferPolyline_2 } from 'cesium';
import { BufferPolylineCollection as BufferPolylineCollection_2 } from 'cesium';
import { BufferPolylineMaterial } from 'cesium';
...
import { CubeMapPanorama as CubeMapPanorama_2 } from 'cesium';
...
import { EquirectangularPanorama as EquirectangularPanorama_2 } from 'cesium';
...
import { TypedArray } from 'cesium';
import { Viewer as Viewer_2 } from 'cesium';
import { WallGraphics as WallGraphics_2 } from 'cesium';
import { WebMapTileServiceImageryProvider as WebMapTileServiceImageryProvider_2 } from 'cesium';
...
export declare const BufferPoint: CesiumComponentType<BufferPoint_2, BufferPointProps>;

export declare const BufferPointCollection: CesiumComponentType<BufferPointCollection_2, BufferPointCollectionProps>;

declare type BufferPointCollectionCesiumProps = PickCesiumProps<BufferPointCollection_2, typeof cesiumProps_5>;

declare type BufferPointCollectionConstructorProps = {
...
declare type BufferPointCollectionOtherProps = {
    children?: ReactNode;
};

export declare type BufferPointCollectionProps = BufferPointCollectionCesiumProps & BufferPointCollectionConstructorProps & BufferPointCollectionOtherProps;

export declare type BufferPointProps = {
...
export declare const BufferPolygon: CesiumComponentType<BufferPolygon_2, BufferPolygonProps>;

export declare const BufferPolygonCollection: CesiumComponentType<BufferPolygonCollection_2, BufferPolygonCollectionProps>;

declare type BufferPolygonCollectionCesiumProps = PickCesiumProps<BufferPolygonCollection_2, typeof cesiumProps_6>;

declare type BufferPolygonCollectionConstructorProps = {
...
declare type BufferPolygonCollectionOtherProps = {
    children?: ReactNode;
};

export declare type BufferPolygonCollectionProps = BufferPolygonCollectionCesiumProps & BufferPolygonCollectionConstructorProps & BufferPolygonCollectionOtherProps;

export declare type BufferPolygonProps = {
...
export declare const BufferPolyline: CesiumComponentType<BufferPolyline_2, BufferPolylineProps>;

export declare const BufferPolylineCollection: CesiumComponentType<BufferPolylineCollection_2, BufferPolylineCollectionProps>;

declare type BufferPolylineCollectionCesiumProps = PickCesiumProps<BufferPolylineCollection_2, typeof cesiumProps_7>;

declare type BufferPolylineCollectionConstructorProps = {
...
declare type BufferPolylineCollectionOtherProps = {
    children?: ReactNode;
};

export declare type BufferPolylineCollectionProps = BufferPolylineCollectionCesiumProps & BufferPolylineCollectionConstructorProps & BufferPolylineCollectionOtherProps;

export declare type BufferPolylineProps = {
...
declare type CameraCesiumProps = PickCesiumProps<Camera_2, typeof cesiumProps_8>;
...
declare type Cesium3DTilesetCesiumProps = PickCesiumProps<Cesium3DTileset_2, typeof cesiumProps_9>;
...
declare type Cesium3DTilesetGraphicsCesiumProps = PickCesiumProps<Merge<Cesium3DTilesetGraphics_2, Cesium3DTilesetGraphics_2.ConstructorOptions>, typeof cesiumProps_10>;
...
declare const cesiumProps_10: readonly ["show", "uri", "maximumScreenSpaceError"];

declare const cesiumProps_11: readonly ["resolutionScale", "useDefaultRenderLoop", "targetFrameRate", "useBrowserRecommendedResolution", "allowDataSourcesToSuspendAnimation", "trackedEntity", "clockTrackedDataSource", "terrainProvider", "creditDisplay"];

declare const cesiumProps_12: readonly ["classificationType", "debugShowBoundingVolume", "debugShowShadowVolume", "show"];

declare const cesiumProps_13: readonly ["canAnimate", "clockRange", "clockStep", "currentTime", "multiplier", "shouldAnimate", "startTime", "stopTime"];

declare const cesiumProps_14: readonly ["noiseDetail", "noiseOffset", "show", "debugBillboards", "debugEllipsoids"];

declare const cesiumProps_15: readonly ["positions", "width", "cornerType", "height", "heightReference", "extrudedHeight", "extrudedHeightReference", "show", "fill", "material", "outline", "outlineColor", "outlineWidth", "granularity", "shadows", "distanceDisplayCondition", "zIndex", "classificationType"];

declare const cesiumProps_16: readonly ["show", "sources"];

declare const cesiumProps_17: readonly ["show", "position", "scale", "maximumSize", "slice", "brightness", "color"];

declare const cesiumProps_18: readonly ["clustering", "name", "show", "clock", "isLoading"];

declare const cesiumProps_19: readonly ["heightReference", "length", "topRadius", "bottomRadius", "show", "fill", "material", "outline", "outlineColor", "outlineWidth", "numberOfVerticalLines", "slices", "distanceDisplayCondition", "shadows"];
...
declare const cesiumProps_20: readonly ["clustering", "show"];

declare const cesiumProps_21: readonly ["semiMajorAxis", "semiMinorAxis", "height", "heightReference", "extrudedHeight", "show", "fill", "material", "outline", "outlineColor", "outlineWidth", "numberOfVerticalLines", "rotation", "stRotation", "granularity", "shadows", "distanceDisplayCondition", "zIndex", "classificationType", "extrudedHeightReference"];

declare const cesiumProps_22: readonly ["heightReference", "radii", "show", "fill", "innerRadii", "material", "maximumClock", "maximumCone", "minimumClock", "minimumCone", "outline", "outlineColor", "outlineWidth", "subdivisions", "stackPartitions", "slicePartitions", "shadows", "distanceDisplayCondition"];

declare const cesiumProps_23: readonly ["availability", "billboard", "box", "corridor", "cylinder", "description", "ellipse", "ellipsoid", "entityCollection", "label", "model", "name", "orientation", "path", "plane", "parent", "point", "polygon", "polyline", "polylineVolume", "position", "properties", "rectangle", "show", "tileset", "trackingReferenceFrame", "viewFrom", "wall"];

declare const cesiumProps_24: readonly ["show"];

declare const cesiumProps_25: readonly ["density", "enabled", "heightFalloff", "heightScalar", "maxHeight", "minimumBrightness", "renderable", "screenSpaceErrorFactor", "visualDensityScalar"];

declare const cesiumProps_26: readonly ["clustering", "name", "show"];

declare const cesiumProps_27: readonly ["atmosphereBrightnessShift", "atmosphereHueShift", "atmosphereSaturationShift", "backFaceCulling", "baseColor", "clippingPlanes", "depthTestAgainstTerrain", "enableLighting", "lightingFadeInDistance", "lightingFadeOutDistance", "material", "maximumScreenSpaceError", "nightFadeInDistance", "nightFadeOutDistance", "oceanNormalMapUrl", "shadows", "show", "showGroundAtmosphere", "showWaterEffect", "tileCacheSize", "loadingDescendantLimit", "preloadAncestors", "preloadSiblings", "fillHighlightColor", "dynamicAtmosphereLighting", "dynamicAtmosphereLightingFromSun", "showSkirts", "cartographicLimitRectangle", "translucency", "undergroundColor", "undergroundColorAlphaByDistance", "lambertDiffuseMultiplier", "atmosphereLightIntensity", "atmosphereRayleighCoefficient", "atmosphereMieCoefficient", "atmosphereRayleighScaleHeight", "atmosphereMieScaleHeight", "atmosphereMieAnisotropy", "vertexShadowDarkness", "clippingPolygons"];

declare const cesiumProps_28: readonly ["appearance", "classificationType", "debugShowBoundingVolume", "debugShowShadowVolume", "show"];

declare const cesiumProps_29: readonly ["appearance", "classificationType", "debugShowBoundingVolume", "debugShowShadowVolume", "show"];
...
declare const cesiumProps_30: readonly ["show", "destroyPrimitives", "primitiveAdded", "primitiveRemoved"];

declare const cesiumProps_31: readonly ["alpha", "brightness", "contrast", "hue", "saturation", "gamma", "splitDirection", "minificationFilter", "magnificationFilter", "cutoutRectangle", "show", "nightAlpha", "dayAlpha", "colorToAlpha", "colorToAlphaThreshold", "index"];

declare const cesiumProps_32: readonly ["clustering", "name", "show"];

declare const cesiumProps_33: readonly ["backgroundColor", "backgroundPadding", "disableDepthTestDistance", "distanceDisplayCondition", "eyeOffset", "fillColor", "font", "heightReference", "horizontalOrigin", "id", "outlineColor", "outlineWidth", "pixelOffset", "pixelOffsetScaleByDistance", "position", "scale", "scaleByDistance", "show", "showBackground", "style", "text", "translucencyByDistance", "verticalOrigin"];

declare const cesiumProps_34: readonly ["blendOption", "coarseDepthTestDistance", "debugShowBoundingVolume", "modelMatrix", "show", "threePointDepthTestDistance"];

declare const cesiumProps_35: readonly ["text", "font", "style", "fillColor", "outlineColor", "outlineWidth", "show", "showBackground", "backgroundColor", "backgroundPadding", "scale", "horizontalOrigin", "verticalOrigin", "eyeOffset", "pixelOffset", "translucencyByDistance", "pixelOffsetScaleByDistance", "scaleByDistance", "heightReference", "distanceDisplayCondition", "disableDepthTestDistance"];

declare const cesiumProps_36: readonly ["backFaceCulling", "clampAnimations", "clippingPlanes", "clippingPolygons", "color", "colorBlendAmount", "colorBlendMode", "customShader", "debugShowBoundingVolume", "debugWireframe", "distanceDisplayCondition", "enableVerticalExaggeration", "featureIdLabel", "heightReference", "id", "imageBasedLighting", "instanceFeatureIdLabel", "lightColor", "maximumScale", "minimumPixelSize", "modelMatrix", "outlineColor", "scale", "shadows", "show", "showCreditsOnScreen", "showOutline", "silhouetteColor", "silhouetteSize", "splitDirection", "style", "pointCloudShading"];

declare const cesiumProps_37: readonly ["uri", "show", "scale", "minimumPixelSize", "maximumScale", "incrementallyLoadTextures", "runAnimations", "clampAnimations", "nodeTransformations", "shadows", "heightReference", "distanceDisplayCondition", "silhouetteColor", "silhouetteSize", "color", "colorBlendMode", "colorBlendAmount", "clippingPlanes", "imageBasedLightingFactor", "lightColor", "articulations", "customShader", "enableVerticalExaggeration", "environmentMapOptions"];

declare const cesiumProps_38: readonly ["onlySunLighting", "show", "textureUrl"];

declare const cesiumProps_39: readonly ["show", "emitter", "modelMatrix", "emitterModelMatrix", "emissionRate", "bursts", "loop", "startScale", "endScale", "startColor", "endColor", "image", "imageSize", "minimumImageSize", "maximumImageSize", "speed", "minimumSpeed", "maximumSpeed", "lifetime", "particleLife", "minimumParticleLife", "maximumParticleLife", "mass", "minimumMass", "maximumMass", "sizeInMeters"];
...
declare const cesiumProps_40: readonly ["leadTime", "trailTime", "show", "width", "material", "resolution", "distanceDisplayCondition", "relativeTo"];

declare const cesiumProps_41: readonly ["plane", "dimensions", "show", "fill", "material", "outline", "outlineColor", "outlineWidth", "shadows", "distanceDisplayCondition"];

declare const cesiumProps_42: readonly ["color", "pixelSize", "outlineColor", "outlineWidth", "show", "scaleByDistance", "translucencyByDistance", "heightReference", "distanceDisplayCondition", "disableDepthTestDistance", "splitDirection"];

declare const cesiumProps_43: readonly ["color", "disableDepthTestDistance", "distanceDisplayCondition", "id", "outlineColor", "outlineWidth", "pixelSize", "position", "scaleByDistance", "show", "splitDirection", "translucencyByDistance"];

declare const cesiumProps_44: readonly ["blendOption", "debugShowBoundingVolume", "modelMatrix", "show"];

declare const cesiumProps_45: readonly ["arcType", "hierarchy", "height", "heightReference", "extrudedHeight", "extrudedHeightReference", "show", "fill", "material", "outline", "outlineColor", "outlineWidth", "stRotation", "granularity", "perPositionHeight", "closeTop", "closeBottom", "shadows", "distanceDisplayCondition", "zIndex", "classificationType", "textureCoordinates"];

declare const cesiumProps_46: readonly ["distanceDisplayCondition", "id", "loop", "material", "positions", "show", "width"];

declare const cesiumProps_47: readonly ["debugShowBoundingVolume", "length", "modelMatrix", "show"];

declare const cesiumProps_48: readonly ["arcType", "classificationType", "positions", "clampToGround", "width", "show", "material", "depthFailMaterial", "granularity", "shadows", "distanceDisplayCondition", "zIndex"];

declare const cesiumProps_49: readonly ["positions", "shape", "cornerType", "show", "fill", "material", "outline", "outlineColor", "outlineWidth", "granularity", "shadows", "distanceDisplayCondition"];

declare const cesiumProps_5: readonly ["show", "debugShowBoundingVolume"];

declare const cesiumProps_50: readonly ["enabled", "selected"];

declare const cesiumProps_51: readonly ["enabled", "selected"];

declare const cesiumProps_52: readonly ["appearance", "cull", "debugShowBoundingVolume", "depthFailAppearance", "modelMatrix", "shadows", "show"];

declare const cesiumProps_53: readonly ["classificationType", "coordinates", "height", "heightReference", "extrudedHeight", "extrudedHeightReference", "show", "fill", "material", "outline", "outlineColor", "outlineWidth", "rotation", "stRotation", "granularity", "shadows", "distanceDisplayCondition", "zIndex"];

declare const cesiumProps_54: readonly ["backgroundColor", "completeMorphOnUserInput", "debugShowCommands", "debugShowDepthFrustum", "debugShowFramesPerSecond", "debugShowFrustumPlanes", "debugShowFrustums", "eyeSeparation", "farToNearRatio", "focalLength", "fog", "gamma", "globe", "highDynamicRange", "invertClassification", "invertClassificationColor", "light", "logarithmicDepthBuffer", "logarithmicDepthFarToNearRatio", "maximumRenderTimeChange", "minimumDisableDepthTestDistance", "moon", "morphTime", "nearToFarDistance2D", "pickTranslucentDepth", "requestRenderMode", "rethrowRenderErrors", "shadowMap", "skyAtmosphere", "skyBox", "specularEnvironmentMaps", "sphericalHarmonicCoefficients", "sun", "sunBloom", "terrainProvider", "useDepthPicking", "useWebVR", "msaaSamples", "splitPosition", "verticalExaggeration", "verticalExaggerationRelativeHeight", "atmosphere"];

declare const cesiumProps_55: readonly ["bounceAnimationTime", "enableCollisionDetection", "enableInputs", "enableLook", "enableRotate", "enableTilt", "enableTranslate", "enableZoom", "inertiaSpin", "inertiaTranslate", "inertiaZoom", "lookEventTypes", "maximumMovementRatio", "maximumZoomDistance", "minimumCollisionTerrainHeight", "minimumPickingTerrainHeight", "minimumTrackBallHeight", "minimumZoomDistance", "rotateEventTypes", "tiltEventTypes", "translateEventTypes", "zoomEventTypes", "minimumPickingTerrainDistanceWithInertia", "maximumTiltAngle", "zoomFactor"];

declare const cesiumProps_56: readonly ["darkness", "fadingEnabled", "maximumDistance", "enabled", "normalOffset", "softShadows", "size"];

declare const cesiumProps_57: readonly ["brightnessShift", "hueShift", "saturationShift", "show", "perFragmentAtmosphere", "atmosphereLightIntensity", "atmosphereRayleighCoefficient", "atmosphereMieCoefficient", "atmosphereRayleighScaleHeight", "atmosphereMieScaleHeight", "atmosphereMieAnisotropy"];

declare const cesiumProps_58: readonly ["sources", "show"];

declare const cesiumProps_59: readonly ["glowFactor", "show"];

declare const cesiumProps_6: readonly ["show", "debugShowBoundingVolume"];

declare const cesiumProps_60: readonly ["clippingPlanes", "maximumMemoryUsage", "modelMatrix", "shadows", "show", "style", "intervals"];

declare const cesiumProps_61: readonly ["terrainShadows", "clockTrackedDataSource", "targetFrameRate", "useDefaultRenderLoop", "resolutionScale", "allowDataSourcesToSuspendAnimation", "trackedEntity", "selectedEntity", "shadows", "useBrowserRecommendedResolution", "creditDisplay"];

declare const cesiumProps_62: readonly ["positions", "maximumHeights", "minimumHeights", "show", "fill", "material", "outline", "outlineColor", "outlineWidth", "granularity", "shadows", "distanceDisplayCondition"];

declare const cesiumProps_63: readonly ["enabled", "selected"];

declare const cesiumProps_7: readonly ["show", "debugShowBoundingVolume"];

declare const cesiumProps_8: readonly ["position", "direction", "up", "right", "frustum", "defaultMoveAmount", "defaultLookAmount", "defaultRotateAmount", "defaultZoomAmount", "constrainedAxis", "maximumZoomFactor", "percentageChanged"];

declare const cesiumProps_9: readonly ["show", "modelMatrix", "shadows", "maximumScreenSpaceError", "cullRequestsWhileMoving", "cullRequestsWhileMovingMultiplier", "preloadWhenHidden", "preloadFlightDestinations", "preferLeaves", "progressiveResolutionHeightFraction", "foveatedScreenSpaceError", "foveatedConeSize", "foveatedMinimumScreenSpaceErrorRelaxation", "foveatedInterpolationCallback", "foveatedTimeDelay", "dynamicScreenSpaceError", "dynamicScreenSpaceErrorDensity", "dynamicScreenSpaceErrorFactor", "dynamicScreenSpaceErrorHeightFalloff", "skipLevelOfDetail", "baseScreenSpaceError", "skipScreenSpaceErrorFactor", "skipLevels", "immediatelyLoadDesiredLevelOfDetail", "loadSiblings", "clippingPlanes", "clippingPolygons", "lightColor", "colorBlendAmount", "colorBlendMode", "debugFreezeFrame", "debugColorizeTiles", "debugWireframe", "debugShowBoundingVolume", "debugShowContentBoundingVolume", "debugShowViewerRequestVolume", "debugShowGeometricError", "debugShowRenderingStatistics", "debugShowMemoryUsage", "debugShowUrl", "style", "backFaceCulling", "showOutline", "vectorClassificationOnly", "vectorKeepDecodedPositions", "splitDirection", "customShader", "imageBasedLighting", "showCreditsOnScreen", "featureIdLabel", "instanceFeatureIdLabel", "outlineColor", "cacheBytes", "maximumCacheOverflowBytes", "enableCollision"];
...
declare type CesiumWidgetCesiumProps = PickCesiumProps<CesiumWidget_2, typeof cesiumProps_11>;
...
declare type ClassificationPrimitiveCesiumProps = PickCesiumProps<Target_2, typeof cesiumProps_12>;
...
declare type ClockCesiumProps = PickCesiumProps<Clock_2, typeof cesiumProps_13> & {
    canAnimate?: boolean;
...
declare type CloudCollectionCesiumProps = PickCesiumProps<CloudCollection_2, typeof cesiumProps_14>;
...
declare type CorridorGraphicsCesiumProps = PickCesiumProps<Merge<CorridorGraphics_2, CorridorGraphics_2.ConstructorOptions>, typeof cesiumProps_15>;
...
export declare const CubeMapPanorama: CesiumComponentType<CubeMapPanorama_2, CubeMapPanoramaProps>;

declare type CubeMapPanoramaCesiumProps = PickCesiumProps<CubeMapPanorama_2, typeof cesiumProps_16>;

declare type CubeMapPanoramaConstructorProps = {
...
export declare type CubeMapPanoramaProps = CubeMapPanoramaCesiumProps & CubeMapPanoramaConstructorProps;

export declare const CumulusCloud: CesiumComponentType<CumulusCloud_2, CumulusCloudCesiumProps>;

declare type CumulusCloudCesiumProps = PickCesiumProps<CumulusCloud_2, typeof cesiumProps_17>;
...
declare type CustomDataSourceCesiumProps = PickCesiumProps<CustomDataSource_2, typeof cesiumProps_18>;
...
declare type CylinderGraphicsCesiumProps = PickCesiumProps<Merge<CylinderGraphics_2, CylinderGraphics_2.ConstructorOptions>, typeof cesiumProps_19>;
...
declare type CzmlDataSourceCesiumProps = PickCesiumProps<CzmlDataSource_2, typeof cesiumProps_20>;
...
declare type EllipseGraphicsCesiumProps = PickCesiumProps<Merge<EllipseGraphics_2, EllipseGraphics_2.ConstructorOptions>, typeof cesiumProps_21>;
...
declare type EllipsoidGraphicsCesiumProps = PickCesiumProps<Target_4, typeof cesiumProps_22>;
...
declare type EntityCesiumProps = PickCesiumProps<Merge<Entity_2, Entity_2.ConstructorOptions>, typeof cesiumProps_23>;
...
export declare const EquirectangularPanorama: CesiumComponentType<EquirectangularPanorama_2, EquirectangularPanoramaProps>;

declare type EquirectangularPanoramaCesiumProps = PickCesiumProps<EquirectangularPanorama_2, typeof cesiumProps_24>;

declare type EquirectangularPanoramaConstructorProps = {
...
export declare type EquirectangularPanoramaProps = EquirectangularPanoramaCesiumProps & EquirectangularPanoramaConstructorProps;
...
declare type FogCesiumProps = PickCesiumProps<Fog_2, typeof cesiumProps_25>;
...
declare type GeoJsonDataSourceCesiumProps = PickCesiumProps<GeoJsonDataSource_2, typeof cesiumProps_26>;
...
declare type GlobeCesiumProps = PickCesiumProps<Globe_2, typeof cesiumProps_27>;
...
declare type GroundPolylinePrimitiveCesiumProps = PickCesiumProps<Target_6, typeof cesiumProps_28>;
...
declare type GroundPrimitiveCesiumProps = PickCesiumProps<Target_7, typeof cesiumProps_29>;
...
declare type GroundPrimitiveCollectionCesiumProps = PickCesiumProps<PrimitiveCollection, typeof cesiumProps_30>;
...
declare type ImageryLayerCesiumProps = PickCesiumProps<Target_8, typeof cesiumProps_31>;
...
declare type KmlDataSourceCesiumProps = PickCesiumProps<KmlDataSource_2, typeof cesiumProps_32>;
...
declare type LabelCesiumProps = PickCesiumProps<Label_2, typeof cesiumProps_33, "position">;

export declare const LabelCollection: CesiumComponentType<LabelCollection_2, LabelCollectionProps>;

declare type LabelCollectionCesiumProps = PickCesiumProps<LabelCollection_2, typeof cesiumProps_34>;
...
declare type LabelGraphicsCesiumProps = PickCesiumProps<Merge<LabelGraphics_2, LabelGraphics_2.ConstructorOptions>, typeof cesiumProps_35>;
...
declare type ModelCesiumProps = PickCesiumProps<Model_2, typeof cesiumProps_36>;
...
declare type ModelGraphicsCesiumProps = PickCesiumProps<Target_11, typeof cesiumProps_37>;
...
declare type MoonCesiumProps = PickCesiumProps<Moon_2, typeof cesiumProps_38>;
...
declare type ParticleSystemCesiumProps = PickCesiumProps<ParticleSystem_2, typeof cesiumProps_39>;
...
declare type PathGraphicsCesiumProps = PickCesiumProps<Merge<PathGraphics_2, PathGraphics_2.ConstructorOptions>, typeof cesiumProps_40>;
...
declare type PlaneGraphicsCesiumProps = PickCesiumProps<Target_13, typeof cesiumProps_41>;
...
declare type PointGraphicsCesiumProps = PickCesiumProps<Target_14, typeof cesiumProps_42>;
...
declare type PointPrimitiveCesiumProps = PickCesiumProps<PointPrimitive_2, typeof cesiumProps_43>;
...
declare type PointPrimitiveCollectionCesiumProps = PickCesiumProps<PointPrimitiveCollection_2, typeof cesiumProps_44>;
...
declare type PolygonGraphicsCesiumProps = PickCesiumProps<Target_15, typeof cesiumProps_45>;
...
declare type PolylineCesiumProps = PickCesiumProps<Polyline_2, typeof cesiumProps_46> & {
...
declare type PolylineCollectionCesiumProps = PickCesiumProps<PolylineCollection_2, typeof cesiumProps_47>;
...
declare type PolylineGraphicsCesiumProps = PickCesiumProps<Target_16, typeof cesiumProps_48>;
...
declare type PolylineVolumeGraphicsCesiumProps = PickCesiumProps<Target_17, typeof cesiumProps_49>;
...
export declare type PostProcessStageCesiumProps = PickCesiumProps<PostProcessStage_2, typeof cesiumProps_63>;

declare type PostProcessStageCesiumProps_2 = PickCesiumProps<Target_18, typeof cesiumProps_50>;
...
declare type PostProcessStageCompositeCesiumProps = PickCesiumProps<Target_19, typeof cesiumProps_51>;
...
declare type PrimitiveCesiumProps = PickCesiumProps<Target_20, typeof cesiumProps_52>;
...
declare type RectangleGraphicsCesiumProps = PickCesiumProps<Target_21, typeof cesiumProps_53>;
...
export declare type ResiumContext = {
    ...
    bufferPointCollection?: BufferPointCollection_2;
    bufferPolylineCollection?: BufferPolylineCollection_2;
    bufferPolygonCollection?: BufferPolygonCollection_2;
...
declare type SceneCesiumProps = PickCesiumProps<Scene_2, typeof cesiumProps_54>;
...
declare type ScreenSpaceCameraControllerCesiumProps = PickCesiumProps<ScreenSpaceCameraController_2, typeof cesiumProps_55>;
...
declare type ShadowMapCesiumProps = PickCesiumProps<Target_22, typeof cesiumProps_56>;
...
declare type SkyAtmosphereCesiumProps = PickCesiumProps<SkyAtmosphere_2, typeof cesiumProps_57>;
...
declare type SkyBoxCesiumProps = PickCesiumProps<Target_23, typeof cesiumProps_58>;
...
declare type SunCesiumProps = PickCesiumProps<Sun_2, typeof cesiumProps_59>;
...
declare type TimeDynamicPointCloudCesiumProps = PickCesiumProps<Target_24, typeof cesiumProps_60, "intervals">;
...
declare type ViewerCesiumProps = PickCesiumProps<Viewer_2, typeof cesiumProps_61>;
...
declare type WallGraphicsCesiumProps = PickCesiumProps<Target_26, typeof cesiumProps_62>;

export declare type WallGraphicsProps = WallGraphicsCesiumProps & WallGraphicsCesiumEvents;

export declare const WebMapTileServiceImageryProvider: CesiumComponentType<WebMapTileServiceImageryProvider_2, WebMapTileServiceImageryProviderProps>;

export declare type WebMapTileServiceImageryProviderProps = {
    ...
    children?: ReactNode;
    /** Calls when the imagery provider is successfully created. */
    onReady?: (provider: WebMapTileServiceImageryProvider_2) => void;
};
